...
rm_if "${WIN_BIN}/npiperelay.exe" "${SYSTEM_ROOT}/system32/taskkill.exe" /im npiperelay.exe /F
rm_if "${WIN_BIN}/wsl-vpnkit.exe" "${SYSTEM_ROOT}/system32/taskkill.exe" /im wsl-vpnkit.exe /F
